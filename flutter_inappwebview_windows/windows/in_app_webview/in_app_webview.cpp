...
namespace flutter_inappwebview_plugin
{
  ...
  void InAppWebView::createInAppWebViewEnv(const HWND parentWindow, const bool &willBeSurface, WebViewEnvironment *webViewEnvironment, const std::shared_ptr<InAppWebViewSettings> initialSettings, std::function<void(wil::com_ptr<ICoreWebView2Environment> webViewEnv, wil::com_ptr<ICoreWebView2Controller> webViewController, wil::com_ptr<ICoreWebView2CompositionController> webViewCompositionController)> completionHandler)
  {
    auto callback = [parentWindow, willBeSurface, completionHandler, initialSettings](HRESULT result, wil::com_ptr<ICoreWebView2Environment> env) -> HRESULT
    {
      ...
      if (willBeSurface && (webViewEnv10 || webViewEnv3))
      {
        ...
        {
          failedLog(webViewEnv10->CreateCoreWebView2CompositionControllerWithOptions(parentWindow, options.get(), Callback<ICoreWebView2CreateCoreWebView2CompositionControllerCompletedHandler>([completionHandler, env](HRESULT result, wil::com_ptr<ICoreWebView2CompositionController> compositionController) -> HRESULT
                                                                                                                                                                                                 {
                ...
                if (succeededOrLog(webViewController->QueryInterface(IID_PPV_ARGS(&webViewController3)))) {
                  ...
                  wil::com_ptr<ICoreWebView2Controller2> webViewController2 = webViewController.try_query<ICoreWebView2Controller2>();
                  if (webViewController2)
                  {
                    // 가상의 예시: UI Automation 활성화 옵션 제어 (실제 API가 다를 수 있음)
                    webViewController2->put_IsUIAutomationEnabled(TRUE);
                    webViewController2->put_IsProgrammaticallyHidden(FALSE);
                  }
                }
      ...
      else
      {
        if (webViewEnv10 && options)
        {
          failedLog(webViewEnv10->CreateCoreWebView2ControllerWithOptions(parentWindow, options.get(), Callback<ICoreWebView2CreateCoreWebView2ControllerCompletedHandler>([completionHandler, env](HRESULT result, wil::com_ptr<ICoreWebView2Controller> controller) -> HRESULT
                                                                                                                                                                           {
  ...
  void InAppWebView::initChannel(const std::optional<std::variant<std::string, int64_t>> viewId, const std::optional<std::string> channelName)
  {
    ...
    channelDelegate = channelName.has_value() ? std::make_unique<WebViewChannelDelegate>(this, plugin->registrar->messenger(), channelName.value()) : std::make_unique<WebViewChannelDelegate>(this, plugin->registrar->messenger());
  }
  ...
  void InAppWebView::prepare(const InAppWebViewCreationParams &params)
  {
    ...
    failedLog(webView->CallDevToolsProtocolMethod(L"Runtime.enable", L"{}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                              {
        failedLog(errorCode);
        return S_OK; })
                                                                                .Get()));
    ...
    failedLog(webView->CallDevToolsProtocolMethod(L"Page.enable", L"{}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                           {
        failedLog(errorCode);
        return S_OK; })
                                                                             .Get()));
    ...
    failedLog(webView->CallDevToolsProtocolMethod(L"Network.enable", L"{}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                              {
        failedLog(errorCode);
        return S_OK; })
                                                                                .Get()));
    ...
    failedLog(webView->CallDevToolsProtocolMethod(L"Fetch.enable", L"{\"patterns\": [{\"resourceType\": \"Document\", \"requestStage\": \"Request\"}]}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                                                                                           {
        failedLog(errorCode);
        return S_OK; })
                                                                                                                                                             .Get()));

    failedLog(webView->CallDevToolsProtocolMethod(L"Page.getFrameTree", L"{}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                 {
  ...
  void InAppWebView::registerEventHandlers()
  {
                  ...
                  ICoreWebView2DevToolsProtocolEventReceivedEventArgs *args) -> HRESULT
              {
                ...
                if (succeededOrLog(args->get_ParameterObjectAsJson(&json)))
                {
                  ...
                  if (!isResponseStage && channelDelegate && settings->useShouldOverrideUrlLoading && string_equals(resourceType, "Document"))
                  {
                    ...
                    auto hasPostData = request.contains("hasPostData") && request.at("hasPostData").is_boolean() && request.at("hasPostData").get<bool>() && request.contains("postDataEntries") && request.at("postDataEntries").is_array();
                    if (hasPostData)
                    {
    ...
    failedLog(webView->add_WebMessageReceived(Callback<ICoreWebView2WebMessageReceivedEventHandler>(
                      ...
                      window." + JAVASCRIPT_BRIDGE_NAME + "[" + std::to_string(callHandlerID) +
                                                                                   "].resolve(" + json + "); \
                      delete window." + JAVASCRIPT_BRIDGE_NAME + "[" + std::to_string(callHandlerID) +
                                                          ...
                                                          callback->error = [this, callHandlerID](const std::string &error_code, const std::string &error_message, const flutter::EncodableValue *error_details)
                                                          {
                                                            ...
                                                            evaluateJavascript("if (window." + JAVASCRIPT_BRIDGE_NAME + "[" + std::to_string(callHandlerID) + "] != null) { \
                      window." + JAVASCRIPT_BRIDGE_NAME + "[" + std::to_string(callHandlerID) +
                                                                                   "].reject(new Error('" + replace_all_copy(errorMessage, "\'", "\\'") + "')); \
                      delete window." + JAVASCRIPT_BRIDGE_NAME + "[" + std::to_string(callHandlerID) +
                                                                                   "]; \
                    }",
                                                                               ContentWorld::page(), nullptr);
                  ...
                  ICoreWebView2DevToolsProtocolEventReceivedEventArgs *args) -> HRESULT
              {
                ...
                if (succeededOrLog(args->get_ParameterObjectAsJson(&json)))
                {
                  ...
                  auto message = join(functional_map(consoleArgs, [](const nlohmann::json &json)
                                                     { return json.contains("value") ? json.at("value").dump() : (json.contains("description") ? json.at("description").dump() : json.dump()); }),
                                      std::string{" "});
        ...
        [this, steps](std::unique_ptr<WebHistory> webHistory)
        {
          if (webHistory && webHistory->currentIndex.has_value() && webHistory->list.has_value())
          {
            ...
            if (nextIndex >= 0 && nextIndex < size)
            {
              ...
              {
                failedAndLog(webView->CallDevToolsProtocolMethod(L"Page.navigateToHistoryEntry", utf8_to_wide("{\"entryId\": " + std::to_string(entryId.value()) + "}").c_str(), Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                                                                                                                   {
                  failedLog(errorCode);
                  return S_OK; })
                                                                                                                                                                                     .Get()));
  ...
  void InAppWebView::getCopyBackForwardList(const std::function<void(std::unique_ptr<WebHistory>)> completionHandler) const
  {
    ...
    failedLog(webView->CallDevToolsProtocolMethod(L"Page.getNavigationHistory", L"{}", Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([completionHandler](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                         {
        if (!completionHandler) {
          return S_OK;
        }
  ...
  void InAppWebView::evaluateJavascript(const std::string &source, const std::shared_ptr<ContentWorld> contentWorld, const std::function<void(std::string)> completionHandler) const
  {
    ...
    userContentController->createContentWorld(contentWorld,
                                              [=](const int &contextId)
                                              {
                                                ...
                                                auto hr = webView->CallDevToolsProtocolMethod(L"Runtime.evaluate", utf8_to_wide(parameters.dump()).c_str(), Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this, completionHandler](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                                                                                              {
  ...
  void InAppWebView::takeScreenshot(const std::optional<std::shared_ptr<ScreenshotConfiguration>> screenshotConfiguration, const std::function<void(const std::optional<std::string>)> completionHandler) const
  {
    ...
    auto hr = webView->CallDevToolsProtocolMethod(L"Page.captureScreenshot", utf8_to_wide(parameters.dump()).c_str(), Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this, completionHandler](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                                                        {
  ...
  void InAppWebView::getCertificate(const std::function<void(const std::optional<std::unique_ptr<SslCertificate>>)> completionHandler) const
  {
    ...
    auto hr = webView->CallDevToolsProtocolMethod(L"Network.getCertificate", utf8_to_wide(parameters.dump()).c_str(), Callback<ICoreWebView2CallDevToolsProtocolMethodCompletedHandler>([this, completionHandler](HRESULT errorCode, LPCWSTR returnObjectAsJson)
                                                                                                                                                                                        {
